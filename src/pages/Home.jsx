        ...
        <section className="relative bg-gray-900 text-white overflow-hidden">
          ...
          <div className="relative max-w-stevens-content-max mx-auto px-stevens-md sm:px-stevens-lg lg:px-stevens-xl py-stevens-section-sm lg:py-stevens-section">
            <div className="grid lg:grid-cols-2 gap-stevens-gap-lg items-center">
              <div>
                <h1
                  className="font-display text-4xl md:text-5xl lg:text-7xl font-bold leading-tight mb-4 animate-in slide-in-from-left duration-700"
                  style={{
                    textShadow:
                      "0 1px 4px rgba(0, 0, 0, 0.6), 0 0 2px rgba(0, 0, 0, 0.7)",
                  }}
                >
                  Advance Your Career with a World-Class Online Master's Degree
                  from Stevens
                </h1>
                <p
                  className="text-xl text-gray-200 mb-8 max-w-xl animate-in slide-in-from-left duration-700"
                  style={{
                    textShadow:
                      "0 0.5px 2px rgba(0, 0, 0, 0.6), 0 0 1px rgba(0, 0, 0, 0.7)",
                  }}
                >
        ...
        <AnimatedSection className="section-dark py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <StatItem value="#9" label="Best ROI Colleges" icon={Award} />
          ...
          <div className="max-w-stevens-content-max mx-auto px-stevens-md lg:px-stevens-lg">
            <AnimatedSection className="text-center mb-stevens-xl">
              <h2 className="font-stevens-display text-stevens-4xl stevens-lg:text-stevens-4xl font-bold text-stevens-gray-900 mb-stevens-lg tracking-tight leading-tight">
                A Degree That{" "}
                <span className="text-stevens-primary">Pays Dividends</span>
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-stevens-2xl">
              ...
              <AnimatedSection>
                <div className="bg-transparent text-stevens-white">
                  ...
                  <p className="text-stevens-white mb-stevens-lg leading-relaxed">
                    Ranked No. 11 in New Jersey for Best Online Master's in
                    Computer Information Technology Programs by U.S. News &
                    World Report (2024), the{" "}
                    <Link
                      to={createPageUrl(
                    ...
                    at Stevens offers you a curriculum aligned with high-demand
                    areas such as software development, web programming, mobile
                    systems and applications, cloud computing, human-computer
                    interaction, and enterprise software design.
                  </p>
                  <Link
              ...
              <AnimatedSection>
                <div className="bg-transparent text-stevens-white">
                  ...
                  <p className="text-stevens-white mb-stevens-lg leading-relaxed">
                    ...
                    is an AACSB-accredited program offered part time through
                    online courses. The Online MBA combines business knowledge
                    with the technology and analytics necessary to excel in
                    today's data-centric world. Students will build upon their
                    managerial toolkits with analytical, data literacy,
                    marketing and operations management skills that drive
              ...
              <AnimatedSection>
                <div className="bg-transparent text-stevens-white">
                  ...
                  <p className="text-stevens-white mb-stevens-lg leading-relaxed">
                    Master the ability to interface between technology and
                    business stakeholders. This program will advance your
                    understanding of the technology involved in engineering
                    projects and the management process through which the
                    technology is applied. Graduates from the{" "}
                    <Link
                      to={createPageUrl(
                    ...
                    program are prepared to add value at the intersection of
                    engineering and management and assume professional positions
              ...
              <AnimatedSection>
                <div className="bg-transparent text-stevens-white">
                  ...
                  <p className="text-stevens-white mb-stevens-lg leading-relaxed">
                    At Stevens, we are proud to offer an array of online
                    programs that challenge the traditional frontiers of
                    technology and business. Compare our programs to find the
                    innovative graduate degree that is the right fit for your
            ...
            <div className="max-w-7xl mx-auto px-stevens-md lg:px-stevens-lg">
              <AnimatedSection className="text-center mb-stevens-2xl">
                ...
                <p className="text-stevens-xl text-stevens-gray-700 max-w-3xl mx-auto">
                  Stay informed with insights, tips, and news about online
                  education, career advancement, and technology trends.
                </p>
              </AnimatedSection>
                ...
                {blogs.map((blog) => (
                  ...
                  >
                    <Card className="h-full flex flex-col hover:shadow-stevens-xl transition-all duration-300 hover:-translate-y-1 border border-stevens-gray-200 hover:border-stevens-primary/30 overflow-hidden">
                      {/* Compact Image - 16:9 aspect ratio, position from JSON */}
                      <div className="aspect-[16/9] w-full overflow-hidden">
                        <img
                          ...
                          style={{
                            objectPosition: blog.image_position || "center",
                          }}
                          loading="lazy"
                        />
                      </div>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <AnimatedSection className="grid md:grid-cols-2 gap-8 mb-8">
                {supportEvents.map((e) => (
                  <Card
                    key={e.title}
                    className="border-0 shadow-stevens-lg hover:shadow-stevens-2xl transition-all duration-stevens-normal bg-stevens-white group overflow-hidden h-full"
                  >
                    <div className="stevens-md:flex stevens-md:flex-row flex flex-col h-full">
                      ...
                      <CardContent className="stevens-md:w-3/5 p-stevens-lg flex flex-col justify-between flex-1">
                        <div>
                          <p className="text-stevens-xs text-stevens-primary font-stevens-bold uppercase tracking-wider my-stevens-xs">
                            On-Demand Event
                          </p>
                          <h3 className="font-stevens-display uppercase font-bold text-stevens-lg font-stevens-bold text-stevens-gray-900 mb-stevens-sm leading-tight group-hover:text-stevens-primary transition-colors duration-stevens-normal">
                            {e.title}
                          </h3>
