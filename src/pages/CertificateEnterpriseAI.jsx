...
const programData = {
  ...
  curriculum: {
    description:
      "The Enterprise AI Certificate consists of three carefully sequenced courses (9 graduate credits total). You'll progress from designing GenAI proof-of-concepts, to understanding AI strategy and governance, to building operational AI workflows. The curriculum emphasizes practical application-every course includes hands-on projects that simulate real business challenges.",
    courseTabs: {
      foundations: {
        ...
        content: `
          ...
          <div class="bg-stevens-gray-50 border-l-4 border-stevens-primary p-stevens-lg rounded-stevens-sm mt-stevens-xl">
            ...
            <p class="text-stevens-sm text-stevens-gray-700 leading-relaxed">
              <strong>BIA 662 → BIA 568 → PE 810</strong><br/>
              This sequence mirrors the AI implementation journey: proof-of-concept → strategy → operationalization. Each course builds essential skills for the next phase.
            </p>
          </div>
        `,
      },
