...
export default function ProfessionalEducation() {
  ...
  useEffect(() => {
    ...
    setMetaDescription(
      "Explore Stevens' professional education programs designed to advance your career with flexible, industry-driven coursework."
    );
    setOpenGraphTags({
  ...
  const steps = [
    {
      ...
      title: "1. Browse",
      description:
        "Explore our catalog of courses by topic and career outcome.",
    },
    {
      icon: UserCheck,
      title: "2. Enroll",
      description:
        "Choose your course and secure your seat in an upcoming cohort.",
    },
    {
      icon: Monitor,
      title: "3. Learn",
    ...
    },
    {
      ...
      title: "4. Certify",
      description:
        "Earn a shareable Stevens certificate to showcase your new skill.",
    },
  ];
    ...
    <div className="min-h-screen bg-stevens-white relative overflow-hidden font-stevens-body">
      ...
      <div className="relative py-stevens-2xl bg-stevens-white/90 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-stevens-sm stevens-md:px-stevens-lg stevens-xl:px-stevens-xl text-center">
          <p className="text-stevens-xl text-stevens-dark-gray mb-stevens-lg leading-relaxed">
            Online courses from Stevens Professional Education. Gain in-demand
            expertise with flexible, 100% online learning designed for working
          ...
          <div className="flex flex-wrap justify-center gap-stevens-md mb-stevens-lg">
            {focusAreas.map((area, index) => (
              <Badge
                key={index}
                variant="outline"
                className="text-stevens-sm py-stevens-sm px-stevens-md bg-stevens-white/80 border-stevens-light-gray hover:border-stevens-red hover:bg-stevens-light-gray transition-all rounded-stevens-md"
              >
                {area}
              </Badge>
            ))}
      ...
      <div className="py-stevens-section bg-stevens-light-gray">
        <div className="max-w-7xl mx-auto px-stevens-sm stevens-md:px-stevens-lg stevens-xl:px-stevens-xl">
          <div className="text-center mb-stevens-2xl">
            <h2 className="font-stevens-display text-stevens-4xl font-stevens-bold text-stevens-dark-gray mb-stevens-md">
              A Simple Path to Certification
            </h2>
            <p className="text-stevens-xl text-stevens-dark-gray max-w-2xl mx-auto">
              Go from Browse to a certified skill in four straightforward steps.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-stevens-lg">
            {steps.map((step, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="group text-center hover:shadow-stevens-2xl transition-all duration-stevens-normal border-0 shadow-stevens-lg bg-stevens-white/90 backdrop-blur-sm hover:-translate-y-2 rounded-stevens-md"
                >
                  <CardContent className="p-stevens-lg">
                    ...
                    <h3 className="font-stevens-display text-stevens-xl font-stevens-bold mb-stevens-md text-stevens-dark-gray">
                      {step.title}
                    </h3>
      ...
      <div className="py-stevens-section bg-stevens-white relative">
        <div className="max-w-7xl mx-auto px-stevens-sm stevens-md:px-stevens-lg stevens-xl:px-stevens-xl">
          <div className="text-center mb-stevens-2xl">
            ...
            <p className="text-stevens-xl text-stevens-dark-gray max-w-2xl mx-auto">
              Whether you're new to Stevens or already part of our community, we
              have you covered.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-stevens-2xl items-start">
            ...
            <Card className="group border-2 border-stevens-light-gray hover:border-stevens-red hover:shadow-2xl transition-all duration-300 bg-stevens-white">
              <CardHeader className="text-center pb-6">
                ...
                <CardTitle className="font-stevens-display text-2xl text-stevens-dark-gray mb-3">
                  Public Learner
                </CardTitle>
                <p className="text-stevens-dark-gray leading-relaxed">
                  Open to everyone. Enroll in any course and earn a Professional
                  Graduate Certificate recognized by the industry.
                </p>
              </CardHeader>
            ...
            <Card className="group border-2 border-stevens-light-gray hover:border-stevens-red hover:shadow-2xl transition-all duration-300 bg-stevens-white">
              <CardHeader className="text-center pb-6">
                ...
                <p className="text-stevens-dark-gray leading-relaxed">
                  For current students, faculty, and staff. Access your included
                  courses here.
                </p>
              </CardHeader>
              <CardContent className="text-center pt-0">
      ...
      <Dialog open={browseModalOpen} onOpenChange={setBrowseModalOpen}>
        <DialogContent className="sm:max-w-md mx-auto my-auto">
          <DialogHeader>
            <DialogTitle className="text-stevens-2xl font-bold text-center text-stevens-dark-gray">
              Browse Our Course Catalog
            </DialogTitle>
            <p className="text-stevens-dark-gray text-center">
          ...
          <div className="flex flex-col gap-stevens-md pt-stevens-md">
            ...
            >
              <Button
                variant="outline-dark"
                className="w-full btn-stevens-outline py-stevens-md text-stevens-lg font-semibold transition-all duration-stevens-normal"
              >
                Public Learner
              </Button>
            </a>
      ...
      <Dialog open={signInModalOpen} onOpenChange={setSignInModalOpen}>
        <DialogContent className="sm:max-w-md mx-auto my-auto">
          <DialogHeader>
            ...
            <p className="text-stevens-dark-gray text-center">
              Please sign in to resume your coursework and track your progress.
            </p>
          </DialogHeader>
          <div className="flex flex-col gap-stevens-md pt-stevens-md">
            <a
