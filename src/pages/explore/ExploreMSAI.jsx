...
const ExploreMSAI = () => {
  ...
  const msaiData = {
    // Hero Section
    heroTitle:
      "Master AI and Launch Your Computer Science Career - All Experience Levels Welcome!",

    heroSubtitle:
      "Specialize in Artificial Intelligence and Machine Learning. 100% online program designed for aspiring AI professionals.",
    ...
    statistics: [
      ...
      },
      {
        ...
        description:
          "Stevens is named one of the Top 20 U.S. Private Schools for Best Career Placement by The Princeton Review (2024).",
      },
      {
        number: "No. 15",
        label: "In Best Value",
        description:
          "Stevens is ranked No. 15 among Best Value Colleges by PayScale (2024).²",
      },
    ],
    ...
    excellenceSectionItems: [
      ...
      },
      {
        ...
        description:
          "The MSCS program will prepare you to adapt to industry disruptors and work as an agile computer science professional. Traditional and accelerated tracks, as well as opportunities to explore areas of focus such as artificial intelligence, help you get the most out of your program experience.",
      },
      {
        title: "Renowned Program Faculty",
        description:
          "The computer science faculty includes active researchers who are renowned experts in artificial intelligence, cybersecurity, software engineering and algorithms.",
      },
    ],
    ...
    programBenefitsDescription:
      "Stevens designed the Online M.S. in Computer Science curriculum to align with in-demand industry skills and emerging technologies, including <strong>machine learning</strong> and <strong>artificial intelligence</strong>, while equipping students with a strong foundation in theory and academic areas of inquiry. Our graduates gain the technical proficiency to engineer solutions and contribute to the future of technology through skills like:",
    programBenefitsImage: "/assets/images/explore-msai/1-explore-msai.webp", // Placeholder
    programBenefitsHighlights: [
      {
        title:
          "Advanced topics like artificial intelligence (AI), machine learning and cloud computing",
        description: "",
      },
      {
    ...
    keyDates: [
      {
        ...
        description: KEY_DATES_SUMMER.EARLY_SUBMIT.details,
      },
      {
        label: "Priority Submit",
        date: KEY_DATES_SUMMER.PRIORITY_SUBMIT.date,
        description: KEY_DATES_SUMMER.PRIORITY_SUBMIT.details,
      },
      {
        label: "Final Submit",
    ...
    additionalWhyChooseStevensImage:
      "/assets/images/explore-msai/2-explore-msai.webp", // Placeholder - should be city skyline image
    ...
    faqs: [
      {
        ...
        answer:
          "Students in the Online Master of Science in Computer Science program are required to take ten classes (30 credit hours). On average, students can earn their degree in less than two years. This timeline may vary depending on how many credits are taken each semester.",
      },
      {
        question: "What is the program format?",
        answer:
          "The M.S. in Computer Science is an online program. This format is centered around students engaging in distance learning coursework to develop skills as software development leaders, AI innovators and high-quality coders.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Connecting with an enrollment advisor will help you: Understand the program admissions criteria and know whether you are eligible to apply, Gain insight into application best practices and how to submit a strong application, Know what to expect in your online classroom, including the level of faculty interaction, program outcomes and more, Have an immediate line of support in the event you have questions or need clarification about the Online MSCS program.",
      },
      {
        question:
          "Is the Online Master's in Computer Science (MSCS) accredited?",
        answer:
    ...
    contactDescription:
      "Schedule a call with our admissions team to discuss your goals and learn about the upcoming cohort of the Online Master of Science in Artificial Intelligence program.",
