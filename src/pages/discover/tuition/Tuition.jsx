...
const FinancialAidOption = ({ title, children }) => (
  <AccordionItem
    value={title}
    className="border border-gray-200 rounded-lg px-5 bg-white shadow-sm data-[state=open]:shadow-md transition-shadow"
  >
          ...
          <div className="lg:col-span-2 space-y-20">
            <div>
              ...
              <p className="text-stevens-lg text-stevens-dark-gray leading-relaxed">
                Students have various options to fund their tuition. We have
                included some of the most frequently used funding options below,
                but encourage you to consult with the Office of Financial Aid or
                a financial advisor when determining the best way to fund your
                tuition.
              </p>
            </div>
            ...
            <Card className="bg-white border-0 shadow-md">
              ...
              <CardContent className="space-y-5">
                <p className="text-stevens-dark-gray leading-relaxed">
                  Effective Spring & Summer 2026, the Online M.S. in Computer
                  Science and Online Master of Engineering in Engineering
                  Management programs will incorporate asynchronous course
                  delivery for the initial phase of their curriculum. This
                  change will impact the tuition rates for some courses.
                </p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <h4 className="font-bold text-stevens-dark-gray mb-3">
                    ...
                    <ul className="space-y-2 text-stevens-dark-gray">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          First four courses are asynchronous.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-stevens-red rounded-full mt-2 flex-shrink-0"></span>
                        <span>
                          <span className="font-medium">Advanced Track:</span>{" "}
                          First two courses are asynchronous.
                        </span>
                      </li>
                    </ul>
                  </div>
            ...
            <div className="text-center">
              ...
              <p className="text-stevens-dark-gray mb-8 max-w-2xl mx-auto leading-relaxed">
                To support this transition, Stevens provides two grants that
                apply a reduced per-credit tuition rate to the first two
              ...
              <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
                ...
                <Card className="text-center shadow-lg bg-stevens-dark-gray border-0 overflow-hidden">
                  <CardHeader className="pb-2">
                    <CardTitle className="flex items-center justify-center gap-3 text-white">
                      <Award className="text-stevens-red w-6 h-6" /> Aspire
                      Grant
                    </CardTitle>
                    <p className="text-sm text-gray-300">
                      (for standard applicants)
                    </p>
                  </CardHeader>
                  <CardContent className="pt-4 pb-8">
                    <p className="font-stevens-headers text-5xl md:text-6xl font-bold text-white mb-2">
                      $3,120
                    </p>
                ...
                <Card className="text-center shadow-lg bg-white border-2 border-stevens-red overflow-hidden">
                  ...
                  <CardContent className="pt-4 pb-8">
                    <p className="font-stevens-headers text-5xl md:text-6xl font-bold text-stevens-red mb-2">
                      $3,120
                    </p>
            ...
            <div>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        ...
                        <TableRow className="bg-white hover:bg-gray-50 border-t-2 border-stevens-red">
                          <TableCell
                            colSpan="3"
                            className="py-4 font-bold text-right text-stevens-dark-gray"
                          >
                            Total Estimated Tuition
                          </TableCell>
                          <TableCell className="py-4 font-bold text-right text-stevens-red text-lg">
                            $38,730
                          </TableCell>
                        </TableRow>
                      </TableBody>
              ...
              <p className="p-4 text-center text-sm text-stevens-dark-gray italic mt-4">
                *Tuition estimates based on Spring & Summer 2026 rates. Tuition
                and fees are subject to change annually. Additional program fees
                may apply.
              </p>
            </div>
            ...
            <div>
              ...
              <Card className="shadow-md border-0 overflow-hidden">
                  ...
                  <TableBody>
                    <TableRow className="bg-white hover:bg-gray-50">
                      <TableCell className="py-4">
                        First two asynchronous courses: Online MSCS/Online MEM
                      </TableCell>
                      <TableCell className="py-4 text-right font-medium">
                        $2,625 per course
                      </TableCell>
                    ...
                    <TableRow className="bg-gray-50 hover:bg-gray-100">
                      ...
                      <TableCell className="py-4 text-right font-medium">
                        $1,395 per credit hour
                      </TableCell>
                    </TableRow>
                    <TableRow className="bg-white hover:bg-gray-50">
                      <TableCell className="py-4">
                        Tuition (First two asynchronous courses: Online
                        MSCS/Online MEM)
                      </TableCell>
                      <TableCell className="py-4 text-right font-medium">
                        $875 per credit hour
                    ...
                    <TableRow className="bg-gray-50 hover:bg-gray-100">
                      <TableCell className="py-4">
                        General Services Fee – Part Time***
                      </TableCell>
                      <TableCell className="py-4 text-right font-medium">
                        $452 per semester
                      </TableCell>
                    ...
                    <TableRow className="bg-white hover:bg-gray-50">
                      <TableCell className="py-4">
                        General Services Fee – Full Time***
                      </TableCell>
                      <TableCell className="py-4 text-right font-medium">
                        $688 per semester
                      </TableCell>
                ...
                <CardContent className="text-sm text-stevens-dark-gray space-y-2 pt-6 pb-6 bg-white border-t border-gray-200">
                  ...
                  <p className="text-xs">
                    *Health Insurance can be waived online with proof of
                    comparable insurance.
                  </p>
                  <p className="text-xs">
                    **Student Activity Fee is charged for students enrolled
                    full-time (9 credits or more) on campus, online, or in
                    Co-op.
                  </p>
                  <p className="text-xs">
                    ***General Service Fee is charged for courses on campus,
                    online, Maintenance of Full-Time Status (Dean-999), CPT, and
                    Co-op.
                  </p>
                </CardContent>
              </Card>
            ...
            <div>
              ...
              <p className="mb-6 text-stevens-dark-gray leading-relaxed text-lg">
                As a graduate student, you may qualify for federal support in
                the form of loans. We strongly encourage every eligible graduate
                student to apply for federal financial aid, even if you don't
                demonstrate an exceptional financial need. Applying for federal
                aid is one of the largest and most common ways for graduate
                students to finance advanced study, and a key part of making
                your program more affordable.
              </p>
              <div className="p-5 bg-white border-l-4 border-stevens-red text-stevens-dark-gray rounded-r-lg mb-8 shadow-sm">
                <p className="text-sm leading-relaxed">
                  <span className="font-semibold">Please note:</span> Students
                  in the Online M.S. in Computer Science and Online MEM programs
                  who choose the Accelerated Application will have access to
                  federal financial aid upon enrollment.
                </p>
              </div>
              ...
              >
                <FinancialAidOption title="Dean’s Merit Scholar Program">
                  <p>
                    Students in the Online MSCS and MEM programs may be eligible
                    for up to $10,000 in scholarship support, while those in the
                    Online MBA program may qualify for up to $25,000 - both
                    based on academic merit. Contact your enrollment advisor to
                    learn more about eligibility.
                  </p>
                </FinancialAidOption>
                <FinancialAidOption title="Direct Unsubsidized Loans">
                  <p>
                    Direct Unsubsidized Loans do not require you to demonstrate
                    financial need to be eligible for the loan. The Direct
                    Unsubsidized Loan for graduate students has a fixed interest
                    rate. The interest on the loan begins to accrue as soon as
                    Stevens receives the first funds. Visit the Federal Aid for
                    Graduate Students page for more information.
                  </p>
                </FinancialAidOption>
                <FinancialAidOption title="Direct Plus Loans">
                  <p>
                    PLUS loans are available if you need to borrow more than
                    what you receive in unsubsidized loans. These loans have
                    higher interest rates and fees than unsubsidized loans and
                    also require a credit check. If you have an adverse credit
                    history, you will need to complete additional documentation
                    and credit counseling before you can receive the loan. Visit
                    the Federal Aid for Graduate Students page for more
                    information.
                  </p>
                </FinancialAidOption>
                <FinancialAidOption title="Private Loans">
                  <p>
                    ...
                    grants and loans before deciding to borrow private student
                    loans. The best time to decide whether to apply for private
                    loans is after you have been accepted to Stevens, applied
                    for aid, and received your aid letter from our financial aid
                    office. Visit the Alternative Financing Options for Graduate
                    Students page for more information.
                  </p>
                </FinancialAidOption>
                <FinancialAidOption title="International Student Loan Resources">
                  <p>
                    We welcome students from all over the world who wish to
                    pursue an advanced degree at Stevens. As is the case with
                    graduate study throughout the United States, aid to
                    international graduate students (those studying in the U.S.
                    on visas) is limited. However, several options are still
                    available and we’re here to help you find them so that you
                    can join us for postgraduate study. Visit the Graduate
                    International Student Resources page for more information.
                  </p>
                </FinancialAidOption>
              </Accordion>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
              <Card className="shadow-md border-0 bg-white hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-stevens-dark-gray leading-relaxed">
                    Stevens alumni can take advantage of a{" "}
                    <span className="font-bold text-stevens-red">
                      15% discount
                    </span>{" "}
                    when they enroll in a Stevens Graduate program. Visit the{" "}
                    <a
                      href="https://www.stevens.edu/admission-aid/graduate-admissions"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-stevens-red hover:underline font-medium"
                    >
              ...
              <Card className="shadow-md border-0 bg-white hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="mb-5 text-stevens-dark-gray leading-relaxed">
                    With a strong commitment to our nation's veterans, Stevens
                    Institute of Technology is proud to participate in the
                    Yellow Ribbon program and offer a suite of resources and
                    support to active duty, veteran and dependent military
                    communities.
                  </p>
                  <ul className="space-y-3">
                    <li>
                      <a
                        href="https://www.stevens.edu/admission-aid/veterans-and-military/yellow-ribbon-program?pg=2"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center text-stevens-red hover:underline font-medium"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.stevens.edu/admission-aid/veterans-and-military?pg=2"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center text-stevens-red hover:underline font-medium"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.stevens.edu/admission-aid/veterans-and-military/using-gi-bill?pg=2"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center text-stevens-red hover:underline font-medium"
                      >
                ...
                <CardContent>
                  ...
                  <div className="bg-white/10 rounded-lg p-4 mb-5 text-center">
                    <p className="text-sm text-gray-300 mb-1">
                      Stevens Institute of Technology College Code:
                    </p>
                    <p className="font-stevens-headers text-5xl font-bold text-white">
                      002639
                    </p>
                  </div>
                  <a
                  ...
                  >
                    <Button
                      variant="default"
                      className="w-full bg-stevens-red hover:bg-red-700 text-white font-semibold py-3"
                    >
                      Go to FAFSA Website{" "}
                ...
                <CardContent className="space-y-4 text-stevens-dark-gray">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium">
                        {CONTACT_INFO.FINANCIAL_AID.PHONE}
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Mail className="w-4 h-4 text-stevens-red flex-shrink-0" />
                      <span className="font-medium text-sm">
                        {CONTACT_INFO.FINANCIAL_AID.EMAIL}
                      </span>
                    </div>
                  </div>
