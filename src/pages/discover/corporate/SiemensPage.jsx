...
export default function SiemensPage() {
    ...
    const programDetails = [
      ...
      `
        ...
        },
        {
            ...
            content: "<p>After successful completion of this program, students will be able to:</p>",
            items: [
    ...
    const pricing = {
        ...
        description: "This exclusive rate is available only to members of the Siemens cohort. This landing page is only for Siemens employees and only accessible through the direct URL. Please do not share outside of the company.",
    }
