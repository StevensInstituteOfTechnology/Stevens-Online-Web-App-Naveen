      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {programs.map((program) => (
            <div
              key={program.code}
              className="bg-white p-6 rounded-xl shadow-sm border border-stevens-light-gray flex flex-col h-full transition-all hover:shadow-lg"
            >
              <h4 className="font-light uppercase tracking-wide text-lg text-stevens-black mb-2">
                {program.title}
              </h4>
              <p className="text-stevens-dark-gray text-sm mb-6 flex-grow">
                {program.description}
              </p>
              <div className="mt-auto space-y-3">
                <Link to={program.exploreLink} target="_blank">
                  <Button
                    ...
                    className="w-full text-[1.3em] px-[31px] py-[21px] min-h-[57px]"
                  >
