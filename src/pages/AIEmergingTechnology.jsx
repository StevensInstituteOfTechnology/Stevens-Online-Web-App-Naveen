...
const TopicList = ({ posts }) => {
  const [selectedCategory, setSelectedCategory] = useState('AI & Emerging Technology');
...
export default function AIEmergingTechnology() {
  ...
  const getInitialState = () => {
    if (slug) {
      ...
      const aiPosts = completeBlogData.posts.filter(post => 
        post.category === 'AI & Emerging Technology'
      );
      return {
        posts: aiPosts,
        singlePost: null
