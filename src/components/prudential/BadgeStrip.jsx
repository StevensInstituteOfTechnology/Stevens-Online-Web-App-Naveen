          ...
          {levelProgress.map((levelData, index) => (
            ...
            >
              <div className={`p-8 rounded-xl border-2 transition-all duration-300 ${
                ...
                {/* Stackability Info */}
                <div className="text-xs text-center p-3 rounded-lg bg-slate-700/50 border border-slate-600/30">
      ...
      >
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div>
            ...
            <div className="text-sm text-slate-400">Programs Selected</div>
          </div>
          <div>
            <div className="text-4xl font-bold mb-2">{totalCredits}</div>
            <div className="text-sm text-slate-400">Total Graduate Credits</div>
          </div>
          <div>
            <div className="text-4xl font-bold mb-2">
              {levelProgress.filter(l => l.completed).length}/{levels.length}
            </div>
            <div className="text-sm text-slate-400">Levels Covered</div>
          </div>
        </div>
      </motion.div>
    </div>
