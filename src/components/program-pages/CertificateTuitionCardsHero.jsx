  ...
  return (
    <div className="w-full grid grid-cols-1 stevens-sm:grid-cols-3 gap-stevens-sm text-center">
      {cards.map((card) => (
        <Card 
          key={card.label} 
          className="p-stevens-xs stevens-md:p-stevens-sm rounded-stevens-lg flex flex-col h-full border-white/60 bg-white/20 backdrop-blur-md cursor-pointer relative overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
          style={{
        ...
        >
          ...
          {/* Top layer: Price */}
          <div className="flex items-center justify-center py-1 relative" style={{ zIndex: 2 }}>
