...
const BlogCard = ({
  ...
  return (
    <Link to={`/blog/${id}/`} className="block">
      <Card
        className={`flex flex-col hover:shadow-stevens-xl transition-all duration-300 hover:-translate-y-2 border border-stevens-gray-200 hover:border-stevens-primary/20 cursor-pointer ${className}`}
      >
